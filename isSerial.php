...
<div class="container-fluid">
    <div class="row">
        ...
        for ($k = 0; $k < 409; $k++) {
            ...
            $additional_class = ($k + 1) % 21 == 0 ? ' mb-50' : '';
            ?>
            <div class="col-4 mt-3<?php echo $additional_class; ?>">
                <div class="card" style="height:200px">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo $k+1; ?> <span style="margin-left: 50%"><?php echo strtoupper($fetch_data[$k]['unique_id']); ?></span></h5>
