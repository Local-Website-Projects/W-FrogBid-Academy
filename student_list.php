                                                        ...
                                                        <div class="col-md-6">
                                                            <div>
                                                                ...
                                                                <div class="form-check mb-3">
                                                                    <input class="form-check-input" type="radio" name="interest" id="formRadios1" value="Art" <?php if($edit_student[0]['interest'] == 'Art') echo 'checked';?>>
                                                                    <label class="form-check-label" for="formRadios1">
                                                                        আর্ট
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-3">
                                                                    <input class="form-check-input" type="radio" name="interest" id="formRadios2" value="Coding" <?php if($edit_student[0]['interest'] == 'Coding') echo 'checked';?>>
                                                                    <label class="form-check-label" for="formRadios2">
                                                                        কোডিং
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-3">
                                                                    <input class="form-check-input" type="radio" name="interest" id="formRadios3" value="Graphic" <?php if($edit_student[0]['interest'] == 'Graphic') echo 'checked';?>>
