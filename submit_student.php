                                    ...
                                    <div class="col-lg-12">
                                        <div>
                                            ...
                                            <form action="#" method="post">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label">ছাত্র/ছাত্রীর নামঃ / Student's Name:
                                                            *</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="age" class="form-control"
                                                                   placeholder="বয়স"
                                                                   value="<?php echo $edit_student[0]['age']; ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            ...
                                                            <input class="form-control" list="datalistOptions"
                                                                   ...
                                                                   value="<?php echo $edit_student[0]['institution']; ?>" required>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="address" class="form-control"
                                                                   placeholder="ঠিকানা"
                                                                   value="<?php echo $edit_student[0]['address']; ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-4">
                                                    <button type="submit" name="update_data"
                                                            class="btn btn-primary w-md">প্রতিযোগীকে নিবন্ধন করুন
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
